...
export function JobCategoriesSection({ categories, loading = false }: JobCategoriesSectionProps) {
  ...
  return (
    <section className="w-full bg-slate-50 py-32 relative overflow-hidden">
      {/* Decorative Blob */}
      <div className="absolute top-0 left-1/4 w-[800px] h-[800px] bg-teal-100/50 rounded-full blur-[100px] -translate-y-1/2 pointer-events-none" />
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="flex flex-col items-center text-center mb-20">
          ...
          <h2 className="text-4xl md:text-5xl font-extrabold text-slate-900 tracking-tight mb-6">
            Browse Jobs by <span className="text-transparent bg-clip-text bg-gradient-to-r from-ink-800 to-violet-600">Category</span>
          </h2>
