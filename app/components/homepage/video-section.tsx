...
export function VideoSection() {
  return (
    <section className="w-full bg-[#030712] py-32 relative overflow-hidden">
      ...
      <div className="absolute top-0 right-0 w-[800px] h-[800px] bg-teal-600/10 blur-[150px] rounded-full pointer-events-none mix-blend-screen" />
      <div className="absolute bottom-0 left-0 w-[600px] h-[600px] bg-violet-600/10 blur-[150px] rounded-full pointer-events-none mix-blend-screen" />
        ...
        <div className="grid lg:grid-cols-[1fr_1.2fr] gap-16 items-center">
          ...
          <div className="space-y-8">
            ...
            <h2 className="text-4xl md:text-6xl font-extrabold text-white leading-[1.1] tracking-tight">
              Empowering <br/> Tacurong's Workforce Since <span className="text-transparent bg-clip-text bg-gradient-to-r from-teal-500 to-violet-600">1999</span>
            </h2>
            
            <p className="text-lg text-slate-400 leading-relaxed font-light max-w-lg">
              Learn how TaraCurong has been connecting talent with opportunity for over two decades, creating sustainable employment and driving economic growth in our community.
            </p>
            
            <div className="flex flex-col sm:flex-row gap-4 pt-4">
              <button className="group relative inline-flex items-center justify-center bg-teal-600 text-white px-8 py-4 rounded-xl font-bold overflow-hidden transition-all duration-300 hover:scale-105 hover:shadow-[0_0_20px_rgba(37,99,235,0.4)]">
          ...
          <div className="relative group">
            ...
            <div className="absolute -inset-4 bg-gradient-to-br from-teal-500 to-purple-600 rounded-[2.5rem] blur-2xl opacity-20 group-hover:opacity-40 transition-opacity duration-700" />
            ...
            <div className="aspect-[16/10] bg-slate-800 rounded-[2rem] overflow-hidden relative shadow-2xl border border-white/10">
              ...
              <div className="absolute inset-0 bg-gradient-to-tr from-[#030712] via-transparent to-ink-900/50" />
              ...
              <div className="absolute inset-0 flex items-center justify-center">
                <button className="w-20 h-20 bg-white/10 backdrop-blur-md border border-white/20 rounded-full flex items-center justify-center group-hover:scale-110 group-hover:bg-white group-hover:border-white transition-all duration-500 cursor-pointer shadow-[0_0_40px_rgba(0,0,0,0.5)]">
                  <Play className="w-8 h-8 text-white group-hover:text-teal-700 ml-1 transition-colors" />
                </button>
              </div>
