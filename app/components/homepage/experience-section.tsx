  ...
  return (
    <section className="relative w-full bg-[#0a0f1c] text-white py-32 overflow-hidden">
      ...
      <div className="absolute inset-0">
        <div className="absolute top-[-10%] right-[-5%] w-[800px] h-[800px] bg-teal-600/20 blur-[150px] rounded-full mix-blend-screen" />
        <div className="absolute bottom-[-10%] left-[-5%] w-[800px] h-[800px] bg-violet-600/20 blur-[150px] rounded-full mix-blend-screen" />
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 z-10">
        <div className="grid lg:grid-cols-[1fr_1.2fr] gap-16 items-center">
          ...
          <div className="space-y-8">
            <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-white/5 border border-white/10 text-teal-100 text-xs font-bold tracking-widest uppercase shadow-sm">
              <Clock className="w-4 h-4" />
              Our Experience
            </div>
            <h2 className="text-4xl md:text-5xl font-extrabold leading-[1.1] tracking-tight">
              Human guidance meets <span className="text-transparent bg-clip-text bg-gradient-to-r from-teal-500 to-violet-600">automation</span> for everyone.
            </h2>
            ...
            <div className="pt-8 mt-8 border-t border-white/10">
              <div className="inline-flex items-center gap-5 rounded-2xl bg-gradient-to-r from-white/10 to-transparent border border-white/10 p-4 backdrop-blur-md">
                <div className="w-12 h-12 bg-teal-500/20 rounded-xl flex items-center justify-center border border-teal-500/30">
                  <span className="text-xl font-black text-teal-500">{loading ? '...' : `${yearsOfService}+`}</span>
                </div>
                <div>
                  <p className="text-white font-bold text-lg">
                    Years Serving Tacurong
                  </p>
          ...
          <div className="grid sm:grid-cols-2 gap-5 relative">
            <div className="hidden lg:block absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-32 h-32 bg-teal-500/30 blur-[60px] rounded-full z-0" />
            ...
            {experienceHighlights.map((item, index) => (
              ...
              >
                ...
                <div className="relative">
                  <div className="w-14 h-14 rounded-2xl bg-gradient-to-br from-teal-500/20 to-violet-600/20 flex items-center justify-center mb-6 border border-white/5 group-hover:scale-110 transition-transform duration-500">
                    <item.icon className="w-7 h-7 text-teal-100" />
                  </div>
