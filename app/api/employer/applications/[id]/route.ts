...
type EmployerApplicationUpdateBody = z.infer<typeof employerApplicationStatusUpdateSchema>;
...
export async function PATCH(
  ...
  const handler = createPatchHandler<EmployerApplicationUpdateBody>(
    async (ctx: ApiHandlerContext, body?: EmployerApplicationUpdateBody) => {
      ...
      await tryCreateNotification({
        ...
        message: `Your application status has been updated to ${updateResult.status}.`,
        relatedId: updateResult.id,
        relatedType: "application",
      });

      return successResponse(
        { message: "Application updated successfully", application: updateResult },
        ctx.requestId
      );
    },
    {
