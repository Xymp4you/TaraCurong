...
async function seed() {
  const users = [
    { 
      email: 'admin_v3@taracurong.com', 
      password: 'Admin123!', 
      role: 'admin', 
      metadata: { full_name: 'System Admin' } 
    },
    { 
      email: 'employer_v3@taracurong.com', 
      password: 'Employer123!', 
      role: 'employer', 
      metadata: { establishment_name: 'TaraCurong Test Employer', industry: 'Services' }
    },
    { 
      email: 'jobseeker_v3@taracurong.com', 
