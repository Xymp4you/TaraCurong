...
/*
  ...
  Usage:
    tsx scripts/bootstrap-role-passwords.ts

  Optional env overrides:
    BOOTSTRAP_ADMIN_EMAIL=admin@taracurong.com
...
async function main() {
  ...
  const adminEmail = (process.env.BOOTSTRAP_ADMIN_EMAIL || "admin@taracurong.com").toLowerCase();
